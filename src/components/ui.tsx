...
import { STATUS_META, PAYMENT_STATUS_META } from "../config/app.config";
import {
  backdropFade,
  modalScale,
  drawerSlideRight,
...
// Safepay payment_status badge — order fulfillment StatusBadge se alag,
// kyunke ek order "confirmed" (fulfillment) ho sakta hai lekin "unpaid"
// (payment) bhi ho sakta hai (e.g. COD). Missing/null status ko "unpaid"
// treat karte hain (DB default).
