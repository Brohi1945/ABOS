...
import { backdropFade, staggerContainer, fadeSlideUp } from "../animations/variants";
      ...
      {open && (
        <div className="fixed inset-0 z-[300] flex items-start justify-center pt-20 px-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-surface border rounded-2xl shadow-2xl overflow-hidden"
          >
