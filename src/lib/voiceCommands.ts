// ============================================================
//  voiceCommands — detects three kinds of spoken/typed UI commands
...
//
//  3. Theme switch ("dark mode laga do", "colorful theme kar do",
//     "light theme on karo") — same reasoning: the LLM can't touch
//     our CSS classes/localStorage, so we intercept and flip the
//     theme directly via ThemeProvider.setTheme.
// ============================================================
...
// Ordered so a strong, unambiguous standalone word (colorful/rangeen/
// aurora/vibrant) can match on its own, while "light"/"dark" — words
// that could show up in an unrelated sentence — require "mode"/"theme"
// alongside them to avoid false positives.
