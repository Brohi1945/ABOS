    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-app flex items-center justify-center p-5" style={{ fontFamily: bodyFont }}>
      ...
      <div className="relative w-full max-w-sm rounded-3xl border shadow-2xl p-2 bg-surface">
        <div className="rounded-[20px] p-7">
          <button onClick={onBack} className="flex items-center gap-1 text-xs font-semibold text-muted mb-5 hover:text-fg">
          ...
          <h2 className="text-xl font-bold text-fg mb-1" style={{ fontFamily: displayFont }}>Welcome back</h2>
          <p className="text-xs text-muted mb-5">Sign in to continue to AB OS.</p>
