...
import { money, computeProductInsights, marginTone, Order, Product } from "../lib/utils";
...
export default function BusinessIntelligenceView({ orders, products }: BusinessIntelligenceViewProps) {
          ...
          <div className="px-5 pb-5 space-y-3">
            {bestSellers.map((p, i) => (
              <div key={p.id} className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-indigo-500/10 text-indigo-400 text-[11px] font-bold flex items-center justify-center shrink-0">
                  {i + 1}
                </div>
