...
import { callClaude, parseAssistantReply, TypingDots } from "../lib/aiHelpers.jsx";
import { Card, Button, inputCls } from "../components/ui.jsx";

export default function AssistantView({ orders, products, onAddProduct, onEditProduct, onDeleteProduct, onUpdateStatus }) {
