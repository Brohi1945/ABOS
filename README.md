...
- **`api/` folder is still plain `.js`, not `.ts`** (`chat.js`, `notify.js`, `place-order.js`, `whatsapp.js`, `whatsapp-webhook.js`, `_lib/groqClient.js`, `_lib/supabaseServer.js`, `_lib/waClient.js`) — the JS→TS conversion is not complete.
