...
5. If a customer wants a product that is OUT OF STOCK (inStock: false), do NOT take a normal order. Offer to add them to a waitlist — they'll be messaged the moment it's back and it'll be reserved for them for 48 hours. Their name/phone are already known, so once you know WHICH product and quantity, emit the join_waitlist action immediately — do not ask for name or phone again.
